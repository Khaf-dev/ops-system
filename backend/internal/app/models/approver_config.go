...
type ApproverConfig struct {
	...
	RequestType uuid.UUID `gorm:"type:uuid;not null;index" json:"request_type_id"`
	...
	//relations (optional)
	RequestTypeObj *RequestType `gorm:"foreignKey:RequestType" json:"request_type,omitempty"`
