...
type ApprovalStep struct {
	...
	FlowID     uuid.UUID `gorm:"type:uuid;not null;index:idx_flow_step,unique" json:"flow_id"`
	StepNumber int       `gorm:"not null;index:idx_flow_step,unique" json:"step_number"`
