...
-- USER_LEVELS (mapping) -- FIXED foreign key to levels
...
-- Extend attachments: file metadata (if not exists)
...
-- Ensure ops_requests.request_date is timestamptz (if originally DATE)
